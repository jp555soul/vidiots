...
class redactorExtrasPlugin extends BasePlugin
{
    ...
    public function init()
	{
		if (craft()->request->isCpRequest())
		{
            ...
            if($settings->inlinestyles === "1")
            {
                craft()->templates->includeCssResource('redactorextras/plugins/colors.css');
                craft()->templates->includeJsResource('redactorextras/plugins/inlinestyles.js');
            }
